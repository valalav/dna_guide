...
<div class="tmrca-tick" style="top: 0%;">31k</div>

<div class="tmrca-tick" style="top: 32%;">21k</div>

<div class="tmrca-tick" style="top: 64%;">11k</div>

<div class="tmrca-tick" style="top: 80%;">6k</div>

<div class="tmrca-tick" style="top: 97%;">1k</div>

<div class="tmrca-tick" style="top: 100%;">700</div>
...
<div class="tmrca-item" style="margin-left: 43%; margin-top: 21px;">
...
<div class="tmrca-item" style="margin-left: 56%; margin-top: 28px;">
...
<div class="tmrca-item" style="margin-left: 59%; margin-top: 29px;">
...
<div class="tmrca-deepest-age">~700 лет</div>
