...
| Уровень | Пример | Вывод |
|---------|--------|-------|
| Поверхностный | G2a = G2a | ❌ Никакой — слишком древний предок |
| Средний | G2a1a = G2a1a | ⚠️ Осторожно — нужны субклады |
| Глубокий | G-Z6653 = G-Z6653 | ⚠️ Ближе, но нужны терминальные SNP |
| Терминальный | G-FGC21495 = G-FGC21495 | ✅ Можно делать выводы о родстве |

### Что НУЖНО проверять:

1. **Терминальные SNP** — последний известный снип в цепочке
2. **Подветви/Субклады** — какие именно нижележащие ветки
3. **TMRCA** — время до общего предка
4. **STR-маркеры** — для групп с одинаковыми SNP
5. **Распределение субкладов** — разнообразие внутри популяции

### Примеры Различий

| Популяция A | Популяция B | Верхний уровень | Реальность |
|-------------|-------------|-----------------|------------|
| Осетины | Балкарцы | G2a1a | Разные субклады Z6653 |
| Сваны | Осетины | G2a1a | Требует глубокого анализа |
| Адыги | Абхазы | G2a2b/L1264 | Разные ветви: Z44222 vs FGC21495 |

### Правило

> [!IMPORTANT]
> **При любом сравнении популяций требуйте:**
> 1. Терминальные SNP (не "G2a", а "G-FGC21495 > Y142023")
> 2. TMRCA из YFull или калькуляторов
> 3. Распределение субкладов внутри популяции
