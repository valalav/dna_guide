...
![Схема с провалами](../assets/yfull/yfull_08.png)

Заметьте: Formed и TMRCA отличаются.
Между 4900 (Formed) и 4400 (TMRCA) — разрыв в 500 лет.
Мы не знаем, что было в эти 500 лет. Потомки рождались, но их боковые линии вымерли. Все ныне живые носители L1264 сводятся к одному человеку, жившему 4400 лет назад.
...
Это мутации, которые накопились лично у вас (в вашей семье) после отделения от ближайшего известного соседа.
Как только ваш брат сдаст тест, часть этих снипов станет "общей" и образует новую ветку с вашим именем.
